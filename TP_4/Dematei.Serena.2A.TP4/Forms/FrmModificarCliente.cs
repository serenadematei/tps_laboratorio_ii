...
namespace Forms
{
    public partial class FrmModificarCliente : Form
    {
        ...
        public FrmModificarCliente(Cliente unCliente)
        {
            ...
            Spa.BuscarClientePorDni(auxCliente, MostrarClienteEncontrado);
           
           
        }

        /// <summary>
        /// Muestra en un rich textbox los datos del cliente encontrado
        /// </summary>
        private void MostrarClienteEncontrado()
        {
            rtb_ClienteEncontrado.Text = auxCliente.ToString();
        }
        ...
        private void btn_AceptarCambios_Click(object sender, EventArgs e)
        {
            ...
            if (NombreValido() && ApellidoValido() && TelefonoValido())
            {
                ...
                if (dao.Modificar(auxCliente))
                {
                    MessageBox.Show("Cliente modificado con exito!");
                }
                else
                {
                    MessageBox.Show("Problema al modificar cliente.");
                }
