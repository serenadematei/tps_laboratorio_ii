        ...
        private void bt_Aceptar_Click(object sender, EventArgs e)
        {
            ...
            {      
                try
                {
                    ...
                    if (dao.GuardarCliente(nuevoCliente) && Spa.AgregarCliente(nuevoCliente))
                    {
                        MessageBox.Show("Cliente cargado con exito en la base de datos. Actualice la lista para ver los cambios");
                        this.Close();
                    }
